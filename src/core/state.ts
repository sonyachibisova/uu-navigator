 ...
 * взаимодействием и сценой (`описание архитектуры проекта`, «Границы модулей»).
 *
...
export interface SceneState {
  ...
  /**
   * Концы маршрута. Оба задаются явно — кнопками «отсюда» и «сюда»
   * в карточке помещения, — и любой из них можно назначить первым:
   * человек с одинаковой вероятностью начинает и с «я тут», и с «мне туда».
   * Пустой конец достраивается следующим выбранным помещением.
   */
